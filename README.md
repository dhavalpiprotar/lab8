...
<body class="bg-light">
    ...
    <header class="bg-primary text-white text-center p-4">
        ...
        <img src="./files/marwadilogo.png.png"
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <p>
                    ...
                    innovation and teamwork for creating professionally superior
                    and ethically strong manpower that meets the global
                    challenges of engineering industries and research
                    organizations.
                </p>
            ...
            <div class="card-body">
                ...
                <ol class="list-group list-group-numbered">
                    ...
                    <li class="list-group-item">
                        ...
                        development of computer-based systems addressing
    ...
    <!-- Image Gallery -->
    <section id="gallery" class="container my-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <h3 class="text-primary fw-bold text-center mb-4">
                    Image Gallery of Events
                </h3>

                <div class="row g-3">

                    <div class="col-md-4">
                        <img src="./files/event1.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>

                    <div class="col-md-4">
                        <img src="./files/event2.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>

                    <div class="col-md-4">
                        <img src="./files/event3.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>

                    <div class="col-md-4">
                        <img src="./files/event4.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>

                    <div class="col-md-4">
                        <img src="./files/event5.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>

                    <div class="col-md-4">
                        <img src="./files/event6.jpg.png"
                             class="img-fluid rounded shadow-sm"
                             alt="College Event">
                    </div>
